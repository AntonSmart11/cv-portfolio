    ...
    <div class="mt-3 information mx-auto">
      ...
      <div class="mt-5">
        <div class="my-3 d-flex gap-3 align-items-center">
          <a href="https://github.com/AntonSmart11" target="_blank">
          ...
          <p class="barlow-bold no-margin">AntonSmart11</p>
        </div>

        <div class="my-3 d-flex gap-3 align-items-center">
          <a href="https://www.linkedin.com/in/antoniooc11/" target="_blank">
          ...
          <p class="barlow-bold no-margin">Antonio Ovando Cauich</p>
        </div>

        <div class="my-3 d-flex gap-3 align-items-center">
          <span class="email" @click="openEmail">
          ...
          <p class="barlow-bold no-margin">antoniooc11@outlook.com</p>
        </div>
      </div>
...
<script setup>
function openEmail() {
  const email = "antoniooc11@outlook.com";
